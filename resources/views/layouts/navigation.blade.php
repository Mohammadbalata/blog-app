        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.articles.index')" :active="request()->routeIs('dashboard.articles.*')">
                        {{ __('Articles') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.tags.index')" :active="request()->routeIs('dashboard.tags.*')">
                        {{ __('Tags') }}
                    </x-nav-link>
                </div>
                @endif
